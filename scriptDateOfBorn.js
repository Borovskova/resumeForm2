...
ccy:null,
updobj:null,
mn:new Array('jan','feb','mar','apr','may','june','jl','aug','sept','oct','nov','dec'),
...
lcs:function(t){ // ����� ���� �������� event ��� this
    if(!t.value){ // ������� event
        e = t || window.event;
        if(e && e.stopPropagation){e.stopPropagation();e.preventDefault();}       // ��� DOM-����������� ���������
        else e.cancelBubble=true; //��� IE
        t=e.target || e.srcElement;
        console.log('_Calendar:lcs - �� ��������');
    }//else ������� this
    if(t){
...
_Calendar.ccy=n.getFullYear();
    ...
    s+="\n"+'<tr style="background:#FF9900;font:12px Arial;color:#FFFFFF"><td align=center>�</td><td align=center>�</td><td align=center>�</td><td align=center>�</td><td align=center>�</td><td align=center>�</td><td align=center>�</td></tr>';
    ...
    s+='<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#FFC266" onclick="_Calendar.today()">�������: '+_Calendar.addnull(_Calendar.sccd,_Calendar.sccm+1,_Calendar.sccy)+'</td></tr>';
    tbl.innerHTML=s;
